...
print(data.loc["2017"][["TEuBA1", "TEuBA2", "TEuBA3"]].describe())
print(data.loc["2018"][["TEuBA1", "TEuBA2", "TEuBA3"]].describe())
print(data.loc["2019"][["TEuBA1", "TEuBA2", "TEuBA3"]].describe())
...
firstTimeSeries = dataToResample.loc["2017-11-05 00:00:00":"2018-01-20 23:59:00"][["TEuBA1", "TEuBA2", "TEuBA3"]]
secondTimeSeries = dataToResample.loc["2018-02-04 00:00:00":"2018-10-27 23:59:00"][["TEuBA1", "TEuBA2", "TEuBA3"]]
thirdTimeSeries = dataToResample.loc["2018-11-04 00:00:00":"2019-02-16 23:59:00"][["TEuBA1", "TEuBA2", "TEuBA3"]]
...
def processStatisticsDailyWithMovingAverage(data, key, window=1):
...
statsVB1 = processStatisticsDailyWithMovingAverage(secondTimeSeries, "TEuBA1")
statsVB2 = processStatisticsDailyWithMovingAverage(secondTimeSeries, "TEuBA2")
statsVB3 = processStatisticsDailyWithMovingAverage(secondTimeSeries, "TEuBA3")
...
ax1.set_xlabel('Date')
ax1.set_ylabel('TEuBA3', color='g')
ax2.set_ylabel('p-Value', color='r')

plt.title('1-Hour Rolling Mean of TEuBA3 and p-Value with LOWESS Filter (Daily)')
